CREATE TABLE `USERS` (
  ...
  `unit` varchar(5) NOT NULL DEFAULT 'kmh',
  PRIMARY KEY (`id`),
...
insert into USERS (username, password, role, salt, unit) values 
('Zaphod', '736addab2f100eb7be2b0494a0316fbc3298b280bd2dc0c8b817654a7193149a625370072f6674f63cc8d58b82f225ed697df26ef6518f60da2900459779cfb0', 'User', 'Zaphod', 'kmh');
