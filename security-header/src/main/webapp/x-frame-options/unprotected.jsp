...
<body>
<body>
<iframe src="../form.jsp" id="form" style="border: 0; width: 100%; height: 100%">
</iframe>
<div style="position: absolute; top: 0; left: 0; width: 50%; height: 50%; border: 5pt; border-color: orange; border-style: solid;">
    <form name="fakeLoginForm" action="FakeServlet" method="post">
        ...
        <div id="hiddenButton" style="cursor: pointer; position: absolute; top: 105; left: 275; z-index: 1; width: 90; height: 40; border: 5pt; border-color: red; border-style: solid;">
