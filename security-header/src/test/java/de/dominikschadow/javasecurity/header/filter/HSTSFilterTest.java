...
/**
 * Tests for the HSTSFilter class.
 *
...
class HSTSFilterTest {
    ...
    void setUp() {
        ...
        hstsFilter = new HSTSFilter();
    }

    @Test
    void doFilter_setsStrictTransportSecurityHeader() throws Exception {
        hstsFilter.doFilter(request, response, filterChain);

        verify(response).addHeader("Strict-Transport-Security", "max-age=31556926; includeSubDomains");
    }
